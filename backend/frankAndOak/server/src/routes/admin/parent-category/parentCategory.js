...
const { insertParentCategory, readParentCategories, updateStatus, readParentCategoryById, updateParentCategory, deleteParentCategory, multiDeleteParentCategory } = require('../../../controllers/controllers');
